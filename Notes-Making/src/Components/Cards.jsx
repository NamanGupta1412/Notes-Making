...
function Cards(props) {
    ...
    return (
        <motion.div drag dragConstraints={props.refrence} whileDrag={{ scale: 1.2 }} className='mt-[80px] ml-11 relative overflow-hidden w-[25vh] h-[33vh] bg-black rounded-3xl text-white py-10 px-6'>
            <FaRegFileAlt />
